...
// still a real file), while SELF-CONTAINED quoted spans (delimited by
// whitespace or operators) are command data and can never be shell
// redirects or operators. Quote spans glued to bare text are shell
// concatenation inside a single word (e.g. open''code.json) and are kept
// for the normalizer to flatten.
